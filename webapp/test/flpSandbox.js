		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Orders",
									"targetURL": "#comsapo2cSDsalesorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapo2cSDsalesorders-display": {
								"semanticObject": "comsapo2cSDsalesorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.o2cSD.salesorders",
									"url": sap.ui.require.toUrl("com/sap/o2cSD/salesorders")
								}
							}
						}
					}
